...
describe("Plugin SDK", () => {
    describe("createPlugin", () => {
        ...
        it("should generate valid LucidPluginManifest", () => {
            ...
            if (manifest.name) expect(typeof manifest.name).toBe("string");
            if (manifest.version) expect(typeof manifest.version).toBe("string");
...
function expectTypeOf<T>(value: T): { toBeObject: () => void } {
    return {
        toBeObject: () => {
