import type { PluginManifestItem } from "@lucidcms/core/types";
import { pluginStoreActions } from "./pluginStore";
 ...
 */
export const loadPluginBundle = async (pluginKey: string): Promise<any> => {
	...
	try {
		...
		const module = await import(/* @vite-ignore */ manifest.bundleUrl);
